# code adapted from https://github.com/DachengLi1/LongChat/blob/longeval/longchat/train/monkey_patch/llama_condense_monkey_patch.py
...
class CondenseRotaryEmbedding(torch.nn.Module):
    def __init__(self, dim, ratio, max_position_embeddings=2048, base=10000, device=None):
        ...
        print(f"Monkey patch: condensing positional embeddings from {max_position_embeddings} to {max_position_embeddings // ratio}")
